...
function buildTooltipHtml(r) {
	...
	return `
		...
		<div class="tt-row"><span class="tt-muted">Similarity Score</span><span>${simPct ?? "-"}%</span></div>
		<div class="tt-row"><span class="tt-muted">Closest Features</span><span>${closestText}</span></div>
	`;
}
